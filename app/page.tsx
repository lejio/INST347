...
const styles = {
  ...
  left: {
    flex: 1.1, background: '#fb2c36', padding: '48px 40px',
  ...
  heroSub: { fontSize: 14, color: '#ffd0cc', lineHeight: 1.7, margin: 0 },
  featureList: {
  ...
  checkDot: {
    background: '#fce405', color: '#fa9189', borderRadius: '50%',
  ...
  tagline: { fontSize: 12, color: '#fa9189', marginTop: 'auto', paddingTop: 32 },
  right: {
